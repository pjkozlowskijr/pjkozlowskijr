...
- Current project highlights:
  ...
  - Building custom WordPress/WooCommerce plugins to enhance functionality of company e-commerce websites. Examples include Google Analytics integration, REST API logging, and age gate.
  - Integrating company e-commerce data with HubSpot through custom API integration.
